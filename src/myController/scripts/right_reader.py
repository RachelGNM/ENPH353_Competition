...
class clueReader:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/B1/rrbot/camera_right/image_right_raw", Image, self.image_callback)
        self.score_pub = rospy.Publisher("/score_tracker", String, queue_size=10)

        # Set up SQLite database
        db_path = os.path.expanduser("/home/fizzer/ros_ws/src/imgRecog/Rclue_database.csv")
        self.init_csv()
    ...
    def init_csv(self):
        self.csv_path = os.path.expanduser("/home/fizzer/ros_ws/src/imgRecog/Rclue_database.csv")
